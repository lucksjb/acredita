...
import br.com.acredita.authorizationserver.annotations.ObrigatorioAlterarSenhaException;
import br.com.acredita.authorizationserver.utils.java.email.EmailException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private ResponseEntity<Object> handleValidationInternal(Exception ex, HttpHeaders headers,
	    ...
	    List<Problem.Campos> problemObjects = bindingResult.getAllErrors().stream()
	    		.map(objectError -> {
	...
	@ExceptionHandler({ ObrigatorioAlterarSenhaException.class })
	public ResponseEntity<Object> handleObrigatorioAlterarSenhaException(ObrigatorioAlterarSenhaException ex, WebRequest request) {
		HttpStatus status = HttpStatus.BAD_REQUEST;
		ProblemType problemType = ProblemType.OBRIGATORIO_TROCA_DE_SENHA;
		String detail = ex.getMessage();
	...
	public ResponseEntity<Object> handleConstraintViolation(ConstraintViolationException ex, WebRequest request) {
		  ...
		  List<Problem.Campos> problemObjects = new ArrayList<>();
		    ...
		    for(ConstraintViolation<?> violation : ex.getConstraintViolations()) {
		        ...
		        problemObjects.add(Problem.Campos.builder()
	...
	public ResponseEntity<Object> EmailException(EmailException ex, WebRequest request) {
	    HttpStatus status = HttpStatus.BAD_REQUEST;
		ProblemType problemType = ProblemType.ERRO_AO_ENVIAR_O_EMAIL;
	    String detail = "Erro ao enviar o email ";
		if (ex.getCause().getMessage() == "Local address contains control or whitespace") {
	     detail = "endereço de email não pode conter espaços em branco e nem caracteres de controle ";
		}	    
		Problem problem = createProblemBuilder(status, problemType, detail)
				.userMessage(detail)
				.build();
